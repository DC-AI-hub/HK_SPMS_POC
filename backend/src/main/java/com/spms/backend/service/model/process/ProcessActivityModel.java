...
/**
 * Represents an activity instance within a process instance.
 */
public class ProcessActivityModel {
    ...
    public Integer getTransactionOrder() { return transactionOrder; }
    public void setTransactionOrder(Integer transactionOrder) { this.transactionOrder = transactionOrder; }
    ...
    public void setInserted(boolean inserted) { this.inserted = inserted; }
