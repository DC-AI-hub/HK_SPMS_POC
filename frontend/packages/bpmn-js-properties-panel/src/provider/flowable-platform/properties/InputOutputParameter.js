...
function Type(props) {
  ...
  const setValue = (value) => {
    ...
    if (value === 'script') {
      properties.definition = createDefinitionElement('flowable:Script');
    }
    else if (value === 'list') {
      properties.definition = createDefinitionElement('flowable:List');
    }
    else if (value === 'map') {
      properties.definition = createDefinitionElement('flowable:Map');
    }
...
function isInput(parameter) {
  return is(parameter, 'flowable:InputParameter');
}