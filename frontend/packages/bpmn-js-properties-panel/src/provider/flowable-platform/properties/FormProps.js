...
function FormKey(props) {
  ...
  const getValue = () => {
    return businessObject.get('flowable:formKey');
  };

  const setValue = (value) => {
    modeling.updateProperties(element, {
      'flowable:formKey': isUndefined(value) ? '' : value
    });
  };
...
function FormRef(props) {
  ...
  const getValue = () => {
    return businessObject.get('flowable:formRef');
  };

  const setValue = (value) => {
    modeling.updateProperties(element, {
      'flowable:formRef': isUndefined(value) ? '' : value
    });
  };
...
function Binding(props) {
  ...
  const setValue = (value) => {
    modeling.updateProperties(element, {
      'flowable:formRefBinding': value
    });
  };

  // Note: default is "latest",
  // cf. https://docs.flowable.org/manual/develop/reference/bpmn20/custom-extensions/extension-attributes/#formrefbinding
  const getOptions = () => {
...
function Version(props) {
  ...
  const getValue = () => {
    return businessObject.get('flowable:formRefVersion');
  };

  const setValue = (value) => {
    modeling.updateProperties(element, {
      'flowable:formRefVersion': value
    });
  };
