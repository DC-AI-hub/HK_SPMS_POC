...
function DelegateVariableMappingType(props) {
  ...
  const setValue = (value) => {
    ...
    if (value === 'class') {
      properties['flowable:variableMappingClass'] = '';
    } else if (value === 'delegateExpression') {
      properties['flowable:variableMappingDelegateExpression'] = '';
    }
...
function VariableMappingDelegateExpression(props) {
  ...
  const getValue = () => {
    return getBusinessObject(element).get('flowable:variableMappingDelegateExpression');
  };
...
function VariableMappingClass(props) {
  ...
  const getValue = () => {
    return getBusinessObject(element).get('flowable:variableMappingClass');
  };
...
function getDelegateVariableMappingType(element) {
  ...
  if (businessObject.get('flowable:variableMappingClass') !== undefined) {
    return 'class';
  } else if (businessObject.get('flowable:variableMappingDelegateExpression') !== undefined) {
