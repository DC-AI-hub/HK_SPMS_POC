...
export function JavaClass(props) {
  ...
  const getValue = () => {
    return businessObject.get('flowable:class');
  };
...
export function Expression(props) {
  ...
  const getValue = () => {
    return businessObject.get('flowable:expression');
  };
...
export function DelegateExpression(props) {
  ...
  const getValue = () => {
    return businessObject.get('flowable:delegateExpression');
  };
...
function Topic(props) {
  ...
  const getValue = () => {
    return businessObject.get('flowable:topic');
  };
...
function ConnectorId(props) {
  ...
  const getValue = () => {
    return connector.get('flowable:connectorId');
  };
...
function getConnectors(businessObject) {
  return getExtensionElementsList(businessObject, 'flowable:Connector');
}
