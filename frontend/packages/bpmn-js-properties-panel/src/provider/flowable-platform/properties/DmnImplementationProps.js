...
function DecisionRef(props) {
  ...
  const getValue = () => {
    return businessObject.get('flowable:decisionRef');
  };
...
function Binding(props) {
  ...
  const setValue = (value) => {
    ...
    const updatedProperties = {
      ...
      'flowable:decisionRefVersionTag': undefined,
      'flowable:decisionRefBinding': value
    };
  ...
  // cf. https://docs.flowable.org/manual/latest/reference/bpmn20/custom-extensions/extension-attributes/#decisionrefbinding
  const getOptions = () => {
...
function Version(props) {
  ...
  const getValue = () => {
    return businessObject.get('flowable:decisionRefVersion');
  };
  ...
  const setValue = (value) => {
    commandStack.execute('element.updateModdleProperties', {
      ...
      moddleElement: businessObject,
      properties: {
        'flowable:decisionRefVersion': value
      }
    });
  };
...
function VersionTag(props) {
  ...
  const getValue = () => {
    return businessObject.get('flowable:decisionRefVersionTag');
  };
  ...
  const setValue = (value) => {
    commandStack.execute('element.updateModdleProperties', {
      ...
      moddleElement: businessObject,
      properties: {
        'flowable:decisionRefVersionTag': value
      }
    });
  };
...
function TenantId(props) {
  ...
  const getValue = () => {
    return businessObject.get('flowable:decisionRefTenantId');
  };
  ...
  const setValue = (value) => {
    commandStack.execute('element.updateModdleProperties', {
      ...
      moddleElement: businessObject,
      properties: {
        'flowable:decisionRefTenantId': value
      }
    });
  };
...
function ResultVariable(props) {
  ...
  // Note: flowable:mapDecisionResult got cleaned up in modeling behavior
  // cf. https://github.com/flowable/flowable-bpmn-js/blob/main/lib/flowable-platform/features/modeling/behavior/UpdateResultVariableBehavior.js
  const setValue = (value) => {
    commandStack.execute('element.updateModdleProperties', {
      element,
      moddleElement: businessObject,
      properties: {
        'flowable:resultVariable': value
      }
    });
  };
...
function MapDecisionResult(props) {
  ...
  const getValue = () => {
    return businessObject.get('flowable:mapDecisionResult') || 'resultList';
  };
  ...
  // cf. https://docs.flowable.org/manual/latest/reference/bpmn20/custom-extensions/extension-attributes/#mapdecisionresult
  const getOptions = () => {
    const options = [
...
function getDecisionRefBinding(element) {
  const businessObject = getBusinessObject(element);
  return businessObject.get('flowable:decisionRefBinding') || 'latest';
}

function getResultVariable(element) {
  const businessObject = getBusinessObject(element);
  return businessObject.get('flowable:resultVariable');
}