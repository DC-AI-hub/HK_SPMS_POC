...
function ErrorMessage(props) {
  ...
  const getValue = () => {
    return error.get('flowable:errorMessage');
  };
...
function ErrorCodeVariable(props) {
  ...
  const getValue = () => {
    return errorEventDefinition.get('flowable:errorCodeVariable');
  };
  ...
  const setValue = (value) => {
    return commandStack.execute(
      'element.updateModdleProperties',
      {
        ...
        properties: {
          'flowable:errorCodeVariable': value
        }
      }
    );
  };
...
function ErrorMessageVariable(props) {
  ...
  const getValue = () => {
    return errorEventDefinition.get('flowable:errorMessageVariable');
  };
  ...
  const setValue = (value) => {
    return commandStack.execute(
      'element.updateModdleProperties',
      {
        ...
        moddleElement: errorEventDefinition,
        properties: {
          'flowable:errorMessageVariable': value
        }
      }
    );
  };
