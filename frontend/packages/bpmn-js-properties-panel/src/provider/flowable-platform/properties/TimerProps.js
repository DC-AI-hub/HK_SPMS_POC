...
function getTimerEventDefinitionValueDescription(timerDefinitionType, translate) {
  ...
  case 'timeDate':
    return (<div>
      ...
      <a href="https://docs.flowable.org/manual/latest/reference/bpmn20/events/timer-events/#time-date" target="_blank" rel="noopener noreferrer">{ translate('Documentation: Timer events') }</a>
    </div>);
  ...
  case 'timeCycle':
    return (<div>
      ...
      <a href="https://docs.flowable.org/manual/latest/reference/bpmn20/events/timer-events/#time-cycle" target="_blank" rel="noopener noreferrer">{ translate('Documentation: Timer events') }</a>
    </div>);
  ...
  case 'timeDuration':
    return (<div>
      ...
      <a href="https://docs.flowable.org/manual/latest/reference/bpmn20/events/timer-events/#time-duration" target="_blank" rel="noopener noreferrer">{ translate('Documentation: Timer events') }</a>
    </div>);
  }
}

function isTimerSupportedOnListener(listener) {
  return listener && is(listener, 'flowable:TaskListener') && getTimerEventDefinition(listener);
}
