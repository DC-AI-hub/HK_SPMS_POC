...
function CandidateStarterGroups(props) {
  ...
  const getValue = () => {
    return process.get('flowable:candidateStarterGroups') || '';
  };
  ...
  const setValue = (value) => {
    commandStack.execute('element.updateModdleProperties', {
      ...
      properties: {
        'flowable:candidateStarterGroups': value
      }
    });
  };
...
function CandidateStarterUsers(props) {
  ...
  const getValue = () => {
    return process.get('flowable:candidateStarterUsers') || '';
  };
  ...
  const setValue = (value) => {
    commandStack.execute('element.updateModdleProperties', {
      ...
      moddleElement: process,
      properties: {
        'flowable:candidateStarterUsers': value
      }
    });
  };
