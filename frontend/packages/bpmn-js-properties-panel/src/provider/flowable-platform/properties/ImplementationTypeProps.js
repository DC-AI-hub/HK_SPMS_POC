...
function ImplementationType(props) {
  ...
  const setValue = (value) => {
    ...
    if (isDelegateType(value)) {
      ...
      updatedProperties = {
        ...updatedProperties,
        [value]: isDelegateType(oldType) ? businessObject.get(`flowable:${oldType}`) : ''
      };
    ...
    // cf. https://github.com/flowable/flowable-bpmn-js/blob/main/lib/flowable-platform/features/modeling/behavior/DeleteErrorEventDefinitionBehavior.js
