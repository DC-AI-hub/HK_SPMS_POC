...
/**
 * Cf. https://docs.flowable.org/manual/7.15/reference/bpmn20/subprocesses/call-activity/#passing-variables
 */
...
function Local(props) {
  ...
  const getValue = () => {
    return mapping.get('flowable:local');
  };
...
function getInMappings(element) {
  ...
  return getExtensionElementsList(signalEventDefinition || businessObject, 'flowable:In');
}
