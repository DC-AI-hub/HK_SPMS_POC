 ...
 * Cf. https://docs.flowable.org/manual/7.15/reference/bpmn20/subprocesses/call-activity/#create-a-case-instance
 */
export function CalledCmmnProps(props) {
  ...
  if (getBusinessObject(element).get('flowable:caseBinding') === 'version') {
    entries.splice(-1, 0,
      {
...
function CaseRef(props) {
  ...
  const getValue = () => {
    return getBusinessObject(element).get('flowable:caseRef');
  };
...
function CaseBinding(props) {
  ...
  const getValue = () => {
    return getBusinessObject(element).get('flowable:caseBinding') || 'latest';
  };
...
function CaseVersion(props) {
  ...
  const getValue = () => {
    return getBusinessObject(element).get('flowable:caseVersion');
  };
...
function CaseTenantId(props) {
  ...
  const getValue = () => {
    return getBusinessObject(element).get('flowable:caseTenantId');
  };
